...
const editForm = useForm({
    ...
    type: props.followup.type || "comment",
...
const submitForm = () => {
    if (!editForm.content || editForm.content.trim() === "") {
        ...
        editForm.setError("content", "Content cannot be empty");
        return;
    }
        ...
        <div class="flex justify-between">
            ...
            <div class="flex flex-col">
                ...
                <div>
                    ...
                    <span
                        v-if="followup.created_at !== followup.updated_at"
